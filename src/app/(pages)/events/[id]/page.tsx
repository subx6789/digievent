...
const EventDetails = () => {
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen md:pt-32 pt-28 pb-16 bg-gray-50 dark:bg-gray-950">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-7 border border-gray-100 dark:border-gray-700 md:col-span-3 lg:col-span-6 order-8"
            ...
            >
              ...
              <div className="flex items-start">
                <motion.div
                  ...
                  className="mr-4 rounded-full overflow-hidden border-2 border-gray-100 dark:border-gray-700 shadow-md h-16 w-16 flex items-center justify-center bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xl font-bold"
                >
                ...
                <div>
                  ...
                  <div className="flex items-center text-gray-700 dark:text-gray-300">
                    ...
                    <span className="text-sm">
                      contact@
                      {event.organizer.toLowerCase().replace(/\s+/g, "")}.com
                    </span>
                  </div>
                </div>
              </div>
